...
@synthesize myTableView,process;
...
-(void)viewInit{
    ...
    [self.myTableView setFrame:CGRectMake(0, self.myScrollView.frame.origin.y+scrollViewH, self.view.frame.size.width, self.view.frame.size.height-44-scrollViewH)];
    [self.myPageControl setFrame:CGRectMake(windowW-100, self.myTableView.frame.origin.y-20, 100, 20)];
...
//设置每一行的高度
- (CGFloat)tableView:(UITableView *)tableViewv heightForRowAtIndexPath :(NSIndexPath *)indexPath {
    CGFloat height = 65.0;
